...
export const API_ENDPOINTS = {
  ...
  UPLOAD_FIELD_IMAGE: `${API_URL}/api/fields`,
  ...
  // Sub-fields management endpoints
  GET_SUB_FIELDS: `${API_URL}/courts`,
  ADD_SUB_FIELD: `${API_URL}/courts`,
  UPDATE_SUB_FIELD: `${API_URL}/courts`,
